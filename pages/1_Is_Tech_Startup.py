...
Example 1 -
Company description: "<Company name> aims to <business objective>. We design innovative solutions that <product use>. We have raised seed funding from some investors in this region."
Website content: <website content>
Industry: <industry>
Output: {{"score": 9, "reason": <detailed reason>, "category": <category>}}

Example 2 -
Company description: "<Company name> invests in early-stage ventures using innovative technology."
Website content: "We invest in emerging startups. <website content>"
Industry: "Venture Capital and Private Equity Principles"
Output: {{"score": 1, "reason": "This is a venture capital firm, not a startup", "category": <category>}}

Example 3 -
Company description: "We are a startup building a cloud-based platform. Our mission is to deliver innovative technology to revolutionize the future."
Website content: <website content>
Industry: <industry>
Output: {{"score": 9, "reason": <detailed reason>, "category": <category>}}

Example 4 -
Company description: "<Company name> provides consultancy services to help startups conceptualise business strategies."
Website content: "We are a consultancy." <website content>
Industry: <industry>
Output: {{"score": 1, "reason": "This is a consultancy firm, not a startup", "category": <category>}}
